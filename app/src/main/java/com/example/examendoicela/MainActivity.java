package com.example.examendoicela;
...
import com.example.examendoicela.ml.ModelDoicela;
...
public class MainActivity extends AppCompatActivity implements OnSuccessListener<Text>, OnFailureListener {
    ...
    public void PersonalizedModel(View v){
        try {
            ...
            String[] etiquetas = {"FCI", "AUDITORIO","BAÑOS", "C_Medico", "COMEDOR","FCIP", "LAGROIND","ACUICULTURA", "LINDUSTRIAL", "PARQUEADERO","POLIDEPORTIVO"};

            ModelDoicela model = ModelDoicela.newInstance(getApplicationContext());
            TensorBuffer inputFeature0 = TensorBuffer.createFixedSize(new int[]{1, 224, 224, 3}, DataType.FLOAT32);
            inputFeature0.loadBuffer(convertirImagenATensorBuffer(mSelectedImage));

            ModelDoicela.Outputs outputs = model.process(inputFeature0);
